<?php
// src/SMO/PlatformBundle/Entity/Advert.php
...
use SMO\PlatformBundle\Validator\Antiflood;
...
class Advert
{
  ...
  /**
   * @ORM\OneToOne(targetEntity="SMO\PlatformBundle\Entity\Image", cascade={"persist", "remove"})
   * @Assert\Valid()
   */
  private $image;
